...
# FR-WEB-011: Serve the negotiated locale at the root without a visible redirect hop
...
- 1.3 The cs-locale cookie SHALL keep priority over Accept-Language negotiation (the FR-WEB-004 contract is preserved).
...
- Changing the locale negotiation rules (FR-WEB-004).
