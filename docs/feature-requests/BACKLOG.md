...
- [done] FR-CHAR-028 - Persist chat transcripts and lead records server-side, including partial conversations - depends: FR-OPS-005, FR-OPS-013
...
- [done] FR-CMS-010 - Insights post template enforces author, dates and a TLDR (improvement) - depends: FR-CMS-007

#### SEO

- [done] FR-SEO-006 - RSS/Atom feed for the insights collection - depends: FR-CMS-007
- [done] FR-SEO-017 - Publish llms.txt / llms-full.txt and take an explicit AI-crawler position (improvement) - depends: FR-SEO-018

#### A11Y

- [done] FR-A11Y-004 - Full keyboard operability, visible focus, and focus order - depends: FR-A11Y-011

#### PERF

- [done] FR-PERF-009 - Defer and consent-gate the analytics tags so they cost nothing on first paint (improvement) - depends: FR-OPS-013
- [done] FR-PERF-011 - Preload the LCP element and give background images correct responsive sizes (improvement) - depends: FR-PERF-005

#### OPS

- [done] FR-OPS-005 - Lead and transcript datastore behind /api/lead and /api/genie - depends: FR-OPS-004
...
- [done] FR-OPS-015 - Implement strict Content-Security-Policy headers in production and report-only in preview (improvement)
