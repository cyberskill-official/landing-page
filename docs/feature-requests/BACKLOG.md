...
- [FR-DS-004](ds/FR-DS-004-liquid-glass-materials.md) - Full Liquid Glass material set (whisper/light/standard/heavy/solid) with all fallbacks. P1. SHOULD. planned.
...
- [FR-PERF-002](perf/FR-PERF-002-lighthouse-ci.md) - Lighthouse CI on mobile emulation per PR. P5. SHOULD. planned.
