...
## §2 ready_to_implement

Eligible for the build queue. An FR cannot enter `implementing` until every `depends_on` FR is `done`.
...
- [ready_to_implement] FR-SCENE-009 - LOD by distance, under 100 draw calls per frame, dispose GPU resources on unmount [Stephen Cheng] - depends: FR-SCENE-001

### CHAR

- [ready_to_implement] FR-CHAR-026 - Conversational lead-capture sequence, value-first, with ICP qualification and a LEAD_CAPTURED state [Stephen Cheng] - depends: FR-CHAR-011
- [ready_to_implement] FR-CHAR-027 - On LEAD_CAPTURED, write the lead to CRM and fire a Slack/email notification with the transcript [Stephen Cheng] - depends: FR-CHAR-026
- [ready_to_implement] FR-CHAR-028 - Persist chat transcripts and lead records server-side, including partial conversations [Stephen Cheng] - depends: FR-CHAR-010
- [ready_to_implement] FR-CHAR-029 - Harden per-IP rate limiting, input validation, and prompt-injection defence on the proxy [Stephen Cheng] - depends: FR-CHAR-010

### CTA

- [ready_to_implement] FR-CTA-005 - Calendar booking embed for high-intent leads [Stephen Cheng] - depends: FR-CTA-001
- [ready_to_implement] FR-CTA-006 - Map form leads to a CRM via webhook [Stephen Cheng] - depends: FR-CTA-001
...
- [ready_to_implement] FR-CMS-003 - Complete Vietnamese localization with native-speaker review [Stephen Cheng] - depends: FR-CMS-001
- [ready_to_implement] FR-CMS-004 - Replace placeholder testimonials with cleared client quotes [Stephen Cheng] - depends: FR-CMS-001
- [ready_to_implement] FR-CMS-005 - Long-form bilingual services content for detail pages [Stephen Cheng] - depends: FR-CMS-001
- [ready_to_implement] FR-CMS-006 - About, team, and culture content (recruiting + trust surface) [Stephen Cheng] - depends: FR-CMS-001
- [ready_to_implement] FR-CMS-007 - Bilingual insights/blog content collection [Stephen Cheng] - depends: FR-CMS-001
- [ready_to_implement] FR-CMS-009 - Replace placeholder case studies with cleared real outcomes [Stephen Cheng] - depends: FR-WEB-003, FR-CMS-001
...
- [ready_to_implement] FR-SEO-006 - RSS/Atom feed for the insights collection [Stephen Cheng] - depends: FR-CMS-007
...
- [ready_to_implement] FR-A11Y-004 - Full keyboard operability, visible focus, and focus order [Stephen Cheng]
- [ready_to_implement] FR-A11Y-008 - Manual VoiceOver and NVDA screen-reader pass [Stephen Cheng]
...
- [ready_to_implement] FR-PERF-005 - Font subset, display, and preload strategy including Vietnamese glyphs [Stephen Cheng] - depends: FR-PERF-001
...
- [ready_to_implement] FR-OPS-004 - Env and secret management across production and preview with separate keys [Stephen Cheng] - depends: FR-OPS-003
- [ready_to_implement] FR-OPS-005 - Lead and transcript datastore behind /api/lead and /api/genie [Stephen Cheng] - depends: FR-CTA-001, FR-CHAR-028
...
- [on_hold] FR-DS-005 - Confirm whether @cyberskill design-system packages are installable [Stephen Cheng] - depends: FR-DS-001
- [on_hold] FR-DS-007 - Style-pack switching layered on the theme [Stephen Cheng] - depends: FR-DS-001, FR-DS-002
- [on_hold] FR-WEB-005 - ISR and on-demand revalidation for content pages [Stephen Cheng] - depends: FR-WEB-002
- [on_hold] FR-WEB-006 - Draft and preview mode for unpublished content [Stephen Cheng] - depends: FR-WEB-002, FR-CMS-001
- [on_hold] FR-SCENE-005 - Authored camera keyframe sequence indexed by section progress [Stephen Cheng] - depends: FR-SCENE-007
- [on_hold] FR-SCENE-008 - WebGPURenderer with automatic WebGL fallback [Stephen Cheng] - depends: FR-SCENE-001
- [on_hold] FR-CHAR-021 - Commission optimised golden-genie GLB (Draco+KTX2, Mixamo rig, ARKit visemes) [Stephen Cheng] - depends: FR-CHAR-020
- [on_hold] FR-CHAR-022 - Integrate the commissioned GLB via gltfjsx, replacing LumiPlaceholder behind the CanvasMount gate [Stephen Cheng] - depends: FR-CHAR-021, FR-SCENE-001
- [on_hold] FR-CHAR-023 - Named animation-clip state machine cross-faded via AnimationMixer, bound to the genie store [Stephen Cheng] - depends: FR-CHAR-022, FR-CHAR-012
- [on_hold] FR-CHAR-024 - Viseme/blendshape lip-sync applied after the mixer each frame [Stephen Cheng] - depends: FR-CHAR-022
- [on_hold] FR-CHAR-025 - Retrieval grounding over company and portfolio facts for richer answers [Stephen Cheng] - depends: FR-CHAR-011
- [on_hold] FR-CTA-004 - Progressive profiling across visits and steps [Stephen Cheng] - depends: FR-CTA-001
- [on_hold] FR-CTA-008 - A/B testbed for first-person CTA copy [Stephen Cheng]
- [on_hold] FR-OPS-008 - Uptime and deploy-health monitoring with alerts [Stephen Cheng] - depends: FR-WEB-010

## §5 closed

- [closed] FR-WEB-008 - Per-service detail pages with static params and hreflang [Stephen Cheng] - depends: FR-WEB-002, FR-CMS-005 - superseded by FR-SEO-016 (service-page depth); the /services/[slug] routes already ship
- [closed] FR-A11Y-009 - Reconcile always-on motion with a user-facing motion control [Stephen Cheng] - superseded by FR-A11Y-010 (reduced-motion JS gate, which also binds the manual toggle)
