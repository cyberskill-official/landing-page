...
# FR-BIZ-004: Claim the Google Business Profile and reconcile the NAP everywhere
...
- 1.1 A Google Business Profile SHALL be claimed and fully populated for the Tan Dinh Ward address, category "Software company", with the canonical entity sentence (FR-SEO-018), hours, photos and the site link.
...
- 1.4 5-10 client reviews SHALL be solicited for the profile (FR-BIZ-005 covers the request mechanics).
...
- Schema markup for the address (FR-SEO-019).
