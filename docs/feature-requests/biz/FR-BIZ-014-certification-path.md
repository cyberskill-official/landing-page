...
# FR-BIZ-014: Decide and start the certification path (ISO 27001 / SOC 2)
...
- 1.3 Until certified, the site SHALL claim only the verifiable engineering commitments it already keeps (FR-CMS-014) - never an in-progress certification as if it were held.
