...
priority: SHOULD
owner: human
depends_on: [FR-BIZ-005]
routed_back_count: 0
awh: N/A
traces_to: [audit-A/phase-5-item-21, growth/GEO-05]
---

# FR-BIZ-015: Monthly AI answer-engine citation check
...
- 1.3 The cited sources SHALL be chased: whichever directory or listicle the engines quote becomes the next outreach target (FR-BIZ-005, FR-BIZ-011).
- 1.4 The brand-confusion result SHALL be tracked as its own line; if engines conflate the two companies, the entity work (FR-SEO-017, FR-SEO-018) is not done.
