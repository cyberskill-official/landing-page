...
# FR-BIZ-007: Establish the social and messaging profiles the site can link to
...
how an answer engine binds the entity across the web. The code side (FR-SEO-019, FR-CTA-012) is blocked on the URLs.
...
- An abandoned profile is worse than none - each one needs an owner and a minimum cadence (FR-BIZ-010).
- The GitHub org is public - it must not expose anything the company would not publish.

## 4. Out of scope / non-goals

- Posting to the profiles (FR-BIZ-010).
