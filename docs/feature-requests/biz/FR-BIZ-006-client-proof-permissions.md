...
- 1.3 Every granted permission SHALL be recorded (who, what was permitted, when, by which named person) and referenced from the content module (FR-CMS-012 clause 1.4).
