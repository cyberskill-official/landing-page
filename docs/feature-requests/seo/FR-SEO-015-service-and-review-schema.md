...
priority: SHOULD
owner: agent
depends_on: [FR-CMS-012]
routed_back_count: 0
awh: N/A
traces_to: [audit-C/phase-2, audit-B/strength-3, audit-A/phase-1-item-5]
---

# FR-SEO-015: Service schema per service page, and Review/AggregateRating once testimonials are verifiable
...
(FR-SEO-003 shipped it - this FR re-verifies it on the service and work templates), Article schema when the notes hub
launches (FR-SEO-004), and Review/AggregateRating once real, attributable testimonials exist.
...
- 1.4 All emitted JSON-LD SHALL validate against the Rich Results test and the result SHALL be recorded in the FR audit.
...
- Writing the service copy (FR-SEO-016).
