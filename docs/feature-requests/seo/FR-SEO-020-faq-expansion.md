...
# FR-SEO-020: Expand the FAQ to 15-20 answerable, citable Q&As
...
- [ ] AC for 1.4 - each answer's first sentence answers the question - reviewed in the FR audit - test: `content/faq-coverage`
