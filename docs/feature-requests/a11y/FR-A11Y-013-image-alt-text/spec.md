...
# FR-A11Y-013: Give the logo and every content image meaningful alt text
...
- Work thumbnails once real screenshots land (FR-CMS-011).
- Client logos (FR-CMS-013) need the company name as alt.
