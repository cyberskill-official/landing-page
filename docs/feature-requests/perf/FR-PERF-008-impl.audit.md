...
FR-PERF-008 is ship-grade. Draw-call ceiling — < 100 per scene at any moment; instancing audit

## §2 — Round-1/2 findings (resolved)

### ISS-80061 — Implementation contract underspecified
- **severity:** error
...
### ISS-80065 — Vietnamese network conditions not in test matrix
- **severity:** warning
...
### ISS-80066 — Sampling bias on low-traffic site (SMB)
- **severity:** info
...
### ISS-80067 — INP vs FID transition for older browsers
- **severity:** info
- **rule_id:** API/contract precision
- **status:** RESOLVED — expanded content addresses via established §1 + §7 clauses; R3 catches gap.
...
Batch 12 item 7 of 29.

*End of FR-PERF-008 audit.*
