...
FR-PERF-010 is ship-grade. navigator.connection.saveData → auto-prompt switch to /lite

## §2 — Round-1/2 findings (resolved)

### ISS-80081 — Implementation contract underspecified
- **severity:** error
...
### ISS-80085 — Vietnamese network conditions not in test matrix
- **severity:** warning
...
### ISS-80086 — Sampling bias on low-traffic site (SMB)
- **severity:** info
...
### ISS-80087 — INP vs FID transition for older browsers
- **severity:** info
- **rule_id:** API/contract precision
- **status:** RESOLVED — expanded content addresses via established §1 + §7 clauses; R3 catches gap.
...
Batch 12 item 9 of 29.

*End of FR-PERF-010 audit.*
