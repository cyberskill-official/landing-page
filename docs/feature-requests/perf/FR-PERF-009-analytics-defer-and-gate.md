...
# FR-PERF-009: Defer and consent-gate the analytics tags so they cost nothing on first paint
...
- 1.2 The Google tag SHALL be gated on the consent stance decided in FR-OPS-013; when consent is absent or denied it SHALL NOT load.
...
- Choosing the consent solution (FR-OPS-013).
