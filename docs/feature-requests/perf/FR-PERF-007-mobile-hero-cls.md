...
# FR-PERF-007: Eliminate the mobile hero layout shift (CLS 0.431 -> below 0.1)
...
- Reducing JavaScript weight (FR-PERF-008).
- Redesigning the hero layout (FR-A11Y-012 handles the CTA-bar overlap).
