...
FR-PERF-003 is ship-grade. Per-scene frameloop='demand' for non-animating scenes

## §2 — Round-1/2 findings (resolved)

### ISS-80011 — Implementation contract underspecified
- **severity:** error
...
Batch 12 item 2 of 29.

*End of FR-PERF-003 audit.*
