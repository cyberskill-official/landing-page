...
pages are FR-WEB-008, still planned). The existing DOM already satisfies the prose
...
that mirrors the FAQ JSON-LD from FR-SEO-001/CMS-002 (clauses 2, 4); all of it
