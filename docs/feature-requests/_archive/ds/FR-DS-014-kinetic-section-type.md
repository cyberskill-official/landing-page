...
depends_on: [FR-DS-011, FR-DS-013]
...
FR-CHAR-031 clause that kept the header CTA visible - operator direction
...
(FR-DS-011 helper, diacritic-safe for VN) into .cs-kt-word masks around
...
background-position stays within 0-100% (the coverage law, FR-DS-012
...
- REVEAL_PROBE on the served build: after scrolling to #services the h2
  ...
  added after catching the hydration-race regression - see the FR-SCENE-004
