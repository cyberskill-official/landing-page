...
# FR-OPS-011: One event taxonomy across both lead paths, with UTM source capture
...
UTM standard, so the external profiles and directories the reports ask for (FR-BIZ-005) would arrive unattributed.
