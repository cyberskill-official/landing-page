...
priority: SHOULD
owner: agent
depends_on: [FR-OPS-009]
routed_back_count: 0
awh: N/A
---

# FR-OPS-015: Implement strict Content-Security-Policy headers in production and report-only in preview
...
- Client-side iframe sandbox attributes for third-party embeds (covered in FR-CTA-005).
