...
# TASK-SEO-014: Complete the OpenGraph and Twitter card fields
...
- twitter:site requires an actual handle - if none exists, the field is omitted rather than faked (TASK-BIZ-007).
- The dynamic OG image route must keep its byte budget.

## 4. Out of scope / non-goals

- Designing new OG artwork (TASK-SEO-008 shipped).
