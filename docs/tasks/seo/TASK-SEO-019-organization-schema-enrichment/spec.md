...
# TASK-SEO-019: Enrich the Organization graph: sameAs, founder, LocalBusiness, and visible profile links
...
- The map/geo coordinates must match the Tan Dinh Ward address, not the old Dakao one (TASK-BIZ-004).

## 4. Out of scope / non-goals

- Creating the profiles themselves (TASK-BIZ-005, TASK-BIZ-007).
