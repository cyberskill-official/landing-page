...
# TASK-BIZ-013: Decide the commercial policy the site is allowed to publish
...
- 1.3 No task that depends on this one SHALL ship a placeholder, an estimate, or an agent-invented value.
...
- [x] AC for 1.2 - the dependent tasks read their values from that record, not from a component - test: `content/no-placeholders`
...
- A promise made and broken is worse than no promise (see TASK-BIZ-009: the measured reply time governs).

## 4. Out of scope / non-goals

- Building the sections that display these (TASK-CTA-015/017/018, TASK-CMS-014/019/020).
