...
priority: SHOULD
owner: mixed
depends_on: [TASK-BIZ-005, TASK-CMS-011]
routed_back_count: 0
awh: N/A
traces_to: [audit-A/phase-3-item-15, audit-A/phase-4-item-18, growth/SEO-08]
---

# TASK-BIZ-011: Earn third-party mentions: listicles, local press, and an awards submission
...
- 1.3 Once at least one named, quantified case study is live (TASK-CMS-011 + TASK-BIZ-006), the site SHALL be submitted to Awwwards and CSSDA.
- 1.4 Every earned mention SHALL be added to the external-listing register (TASK-BIZ-004) and, where appropriate, to sameAs.
