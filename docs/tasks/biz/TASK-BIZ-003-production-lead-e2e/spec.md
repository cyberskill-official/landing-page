...
priority: MUST
owner: human
depends_on: [TASK-BIZ-001]
routed_back_count: 0
awh: N/A
traces_to: [growth/LEAD-05]
---

# TASK-BIZ-003: Prove the lead pipeline end to end in production
...
- The weekly synthetic check (TASK-OPS-010) - this is the first, manual proof.
