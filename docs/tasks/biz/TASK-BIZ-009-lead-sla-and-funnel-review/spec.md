...
priority: SHOULD
owner: mixed
depends_on: [TASK-BIZ-002, TASK-OPS-011, TASK-OPS-020]
routed_back_count: 0
awh: N/A
traces_to: [growth/NURT-04, growth/MEAS-04, growth/NURT-03, audit-A/section-9]
---

# TASK-BIZ-009: Lead system of record, SLA ritual, and the weekly funnel review
...
- 1.1 Every lead SHALL land in one system of record with a status (new, contacted, proposal, won, lost) and a next-action date. **CyberOS is that system of record once TASK-BIZ-002/TASK-BIZ-003 are green.** Until then only, a shared sheet with the same columns MAY serve as an interim SoR; the sheet SHALL be retired after CyberOS e2e proof and dual-write migration (TASK-OPS-020).
...
- 1.4 The measured median first-reply time SHALL be the number the site is allowed to publish (TASK-CMS-014); if it exceeds the promise, the promise changes, not the measurement.
...
- A lead that arrives only by email because a sink failed (TASK-OPS-010) must still enter the record.

## 4. Out of scope / non-goals

- Building the CyberOS CRM product (TASK-BIZ-016 / TASK-BIZ-002).
