...
# TASK-CHAR-029: Harden per-IP rate limiting, input validation, and prompt-injection defence on the proxy
...
- Provisioning the KV (TASK-OPS-004 owns the env and secret scoping).
