...
of TASK-DS-011: a blueprint grid behind the hero, a monospace micro-meta row
...
1.4 The TASK-DS-011 rules keep applying: transform/opacity/paint-only
...
- Visual QA (puppeteer, dark default + light opt-in + /vi): veil on umber,
  ...
  VN diacritics uniform (TASK-DS-008), VN story copy reading native.
- Duplicate heading resolved: SocialProof fallback now "What we stand
  behind" / "Điều chúng tôi cam kết".
- Copy remains agent-polished, not native-reviewed: TASK-CMS-003 (Vietnamese
