...
priority: SHOULD
owner: agent
depends_on: [TASK-OPS-001]
routed_back_count: 0
awh: N/A
---

# TASK-OPS-016: Optimize SVG vector assets in build/CI and enforce file-size budgets
...
## 4. Out of scope
- Optimizing non-vector image formats (handled in TASK-PERF-010).
