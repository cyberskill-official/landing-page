...
# TASK-OPS-009: Add a Content-Security-Policy, report-only first
...
- [ ] AC for 1.4 - the enforcing flip is a one-line change recorded in the task audit - test: `headers/csp-present`
...
- GA4 (TASK-PERF-009) needs an allowance only if consent lets it load.
