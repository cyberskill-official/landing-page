...
# TASK-CMS-011: Work-detail template that can carry proof: metrics band, client quote, screenshots
...
- 1.4 Screenshots SHALL be lazy-loaded, sized within the image budget, and carry alt text (TASK-A11Y-013).
...
- Screenshots may contain client data - they must be cleared (TASK-BIZ-006).
- Image budget must hold with three screenshots per case study.

## 4. Out of scope / non-goals

- Obtaining the client permissions and numbers (TASK-BIZ-006).
