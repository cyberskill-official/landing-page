...
priority: SHOULD
owner: mixed
depends_on: [TASK-BIZ-006]
routed_back_count: 0
awh: N/A
traces_to: [audit-A/phase-2-item-8, audit-C/content-credibility, growth/PROOF-05]
---

# TASK-CMS-006: About, team, and culture content (recruiting + trust surface)
...
- 1.1 The content SHALL cover the company story (founded 2020, Ho Chi Minh City, the slogan), the team and the working culture, sourced from the publishable content read model (TASK-CMS-001 module today; CyberOS via TASK-OPS-019 when configured, with git fallback).
...
- 1.3 Every string SHALL ship English and Vietnamese, with the Vietnamese reviewed by a native speaker (TASK-CMS-003).
...
- The /team route (TASK-WEB-012).
- Obtaining the photos and consents (TASK-BIZ-006).
