...
priority: SHOULD
owner: agent
depends_on: [TASK-SEO-016]
routed_back_count: 0
awh: N/A
traces_to: [research-doc/section-D, audit-C/on-page-seo]
---

# TASK-CMS-005: Long-form bilingual services content for the detail pages
...
- 1.1 Every service detail page SHALL draw its copy from the TASK-CMS-001 content module; no detail copy SHALL be hardcoded in a component.
...
- VN copy is a native pass, not a translation (TASK-CMS-003).

## 4. Out of scope / non-goals

- The page depth target and the FAQ blocks (TASK-SEO-016).
