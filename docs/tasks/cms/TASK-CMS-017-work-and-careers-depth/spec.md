...
# TASK-CMS-017: Deepen the work index and careers pages
...
- 1.2 The careers page SHALL cover: how the team works, the hiring process end to end, what seniority means here, the tools and gates a new engineer will meet, and current openings (or the honest statement that none are open, with the talent-pool capture from TASK-CTA-020).
