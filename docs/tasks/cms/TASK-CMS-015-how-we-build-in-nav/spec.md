...
# TASK-CMS-015: Promote How-we-build into the nav and surface the quality gates as proof
...
- 1.3 The Team nav item SHALL point at the real route (TASK-WEB-012), and the stale anchor SHALL be removed sitewide.
...
- Adding a nav item must not overflow the mobile header (TASK-A11Y-011).
