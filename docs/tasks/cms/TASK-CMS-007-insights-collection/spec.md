...
# TASK-CMS-007: Bilingual insights/notes content collection
...
- A long post must not blow the page-weight budget (TASK-PERF-008).

## 4. Out of scope / non-goals

- Writing the posts.
- The RSS feed (TASK-SEO-006).
- The author/TLDR enforcement (TASK-CMS-010).
