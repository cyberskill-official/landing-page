...
# TASK-CMS-014: "Verify us" block: registration, DUNS, address, repositories
...
- The address must be the current Tan Dinh Ward one, matching every external listing (TASK-BIZ-004).
- A claimed gate that is later removed from CI must fail the parity test.

## 4. Out of scope / non-goals

- Pursuing ISO 27001 / SOC 2 (TASK-BIZ-014).
