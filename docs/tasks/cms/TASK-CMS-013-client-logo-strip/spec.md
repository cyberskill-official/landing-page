...
# TASK-CMS-013: Client logo strip, with an honest interim line until logos are cleared
...
- 1.4 The logo row SHALL stay inside the image budget and SHALL NOT shift layout (TASK-PERF-007).
...
- Obtaining the logo files and permissions (TASK-BIZ-006).
