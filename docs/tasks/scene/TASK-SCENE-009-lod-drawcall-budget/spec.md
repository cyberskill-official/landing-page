...
# TASK-SCENE-009: Draw-call budget, GPU disposal, and LOD for the scene
...
- 1.4 Distance-based level-of-detail SHALL swap to lighter meshes as the subject recedes (deferred to TASK-CHAR-021 - meaningless until the multi-resolution GLB exists).
...
- The LOD meshes themselves (TASK-CHAR-021, on hold).
- Pausing the render loop (TASK-PERF-012).
