...
priority: MUST
owner: agent
depends_on: [TASK-A11Y-011]
routed_back_count: 0
awh: N/A
traces_to: [research-doc/section-H, audit-B/finding-14-low]
---

# TASK-A11Y-004: Full keyboard operability, visible focus, and focus order
...
- The manual screen-reader pass (TASK-A11Y-008).
- Enlarging the tap targets (TASK-A11Y-011).
