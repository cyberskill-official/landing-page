...
priority: SHOULD
owner: mixed
depends_on: [TASK-A11Y-004]
routed_back_count: 0
awh: N/A
traces_to: [research-doc/section-H, audit-C/responsiveness]
---

# TASK-A11Y-008: Manual VoiceOver and NVDA screen-reader pass
...
- 1.3 Each finding SHALL be logged with the route, the tool, the observed behaviour and the expected behaviour, and tracked to a fix or an task.
...
- Fixing what the pass finds - each finding becomes its own task or a fix in the owning task.
