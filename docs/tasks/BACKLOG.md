...
- [ready_to_review] TASK-SEO-021 - IndexNow submission so Bing and Yandex learn about changes without waiting for a crawl (improvement)
- [ready_to_review] TASK-SEO-022 - Link the practice subdomain from the main site so it stops being an orphan (improvement)
- [ready_to_review] TASK-SEO-023 - Emit x-default in the sitemap so it agrees with the head hreflang set (improvement)
