...
- [x] AC for 1.1 - the line renders from config, both locales - test: `content/capacity-line`
- [x] AC for 1.2 - unset or stale config renders nothing - test: `content/capacity-line`
- [x] AC for 1.3 - the rendered values equal the owner's recorded numbers (TASK-BIZ-013) and carry a review date - test: `content/commercial-policy-record`
...
- A booking calendar (TASK-CTA-005).
