...
# TASK-CTA-011: Auto-acknowledgement email to the lead, localized
...
- 1.4 Synthetic leads (TASK-OPS-010) SHALL be skipped.
- 1.5 Without the mail provider env var the acknowledgement sink SHALL be skipped (not failed), the lead SHALL still be accepted, and the skip SHALL NOT count as a sink failure in TASK-OPS-010.
...
- Domain verification and the API key (TASK-BIZ-001).
