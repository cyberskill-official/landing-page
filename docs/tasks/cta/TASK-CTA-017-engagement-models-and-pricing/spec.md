...
# TASK-CTA-017: Engagement models and price signals section
...
- 1.2 The ranges and timelines SHALL be the owner-approved values (TASK-BIZ-013); the section SHALL NOT ship with placeholder numbers.
- 1.3 It SHALL be linked from the services pages and reflected in the FAQ (TASK-SEO-020).
