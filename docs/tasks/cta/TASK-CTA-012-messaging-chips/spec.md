...
# TASK-CTA-012: Zalo and WhatsApp one-tap contact chips, config-driven
...
- 1.3 Each chip SHALL emit a cta_clicked event with its location and label (TASK-OPS-011), and carry an accessible name in the active locale.
...
- Creating the Zalo OA (TASK-BIZ-007).
