...
priority: SHOULD
owner: agent
depends_on: [TASK-OPS-010]
routed_back_count: 0
awh: N/A
traces_to: [research-doc/section-O, growth/LEAD-02]
---

# TASK-CTA-006: Map form leads to the CRM via a server-side webhook
...
- 1.3 A failed CRM call SHALL be logged and SHALL NOT fail the visitor's submission (best-effort fan-out), but SHALL count toward the total-failure alert in TASK-OPS-010.
...
- Deploying the CRM endpoint (TASK-BIZ-002).
