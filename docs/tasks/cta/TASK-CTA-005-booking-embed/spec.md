...
priority: SHOULD
owner: mixed
depends_on: [TASK-BIZ-013, TASK-CTA-010]
routed_back_count: 0
awh: N/A
traces_to: [growth/CONV-02, audit-A/section-9, audit-B/finding-2-high]
---

# TASK-CTA-005: Call-booking path for high-intent leads (link, not embed)
...
- 1.1 A secondary action ("Book a 30-minute call") SHALL render in the contact section and on the thank-you panel (TASK-CTA-010), opening the booking URL in a new tab.
...
- 1.3 The click SHALL emit `booking_clicked` (TASK-OPS-011).
...
- Creating the booking account and supplying the URL (TASK-BIZ-013).
