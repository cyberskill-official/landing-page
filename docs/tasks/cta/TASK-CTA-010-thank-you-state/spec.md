...
# TASK-CTA-010: Thank-you state with next steps, and a trust line under the form
...
- The booking URL itself (TASK-CTA-005).
- The acknowledgement email (TASK-CTA-011).
...
- A submitted lead is never silently lost (TASK-OPS-010).
