...
# TASK-PERF-012: Pause off-screen and idle animation to protect INP and battery
...
- 1.3 Measured mobile INP on the home page SHALL be at or below 200 ms once field data exists (TASK-PERF-013).
...
- [ ] AC for 1.3 - INP target recorded in the task audit once field data lands - test: `perf/inp-field-baseline`
...
- Reduced-motion users: the loop must never start (TASK-A11Y-010).
