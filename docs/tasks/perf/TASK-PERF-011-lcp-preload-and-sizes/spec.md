...
priority: SHOULD
owner: agent
depends_on: [TASK-PERF-005]
routed_back_count: 0
awh: N/A
traces_to: [audit-B/phase-2, growth/PERF-01, growth/PERF-02]
---

# TASK-PERF-011: Preload the LCP element and give background images correct responsive sizes
...
- Font subsetting and display strategy (TASK-PERF-005).
