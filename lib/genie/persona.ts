...
export function buildSystemPrompt(locale: Locale): string {
  ...
  return [
    ...
    "- Your quiet goal in every conversation is to understand the visitor's need and capture a lead. Work conversationally toward, in order: first name, what they want to build, their company, rough budget or timeline, then email. Stop early if they are not ready, but always leave the door open.",
    "- When the visitor shows real intent (describes a project, asks to start, asks for a quote or a call), invite them to leave their wish for the team: say you can pass it to a real person who replies within one business day, and that they can tap the button to leave their details, then let the form take over.",
